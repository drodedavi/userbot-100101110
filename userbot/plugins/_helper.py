...
async def cmd_list(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        if tgbotusername is None or input_str == "text":
            ...
            help_string = f"""**🤖 Ciao** [Dανiδe🐰🥕⁪⁬⁮⁮⁮⁮](t.me/notdavi) **sono il tuo BOT helper**\n\n**ℹ️ Clicca su un bottone per avere informazioni su un comando o contatta @lordrxns per problemi/assistenza.**\n"""
